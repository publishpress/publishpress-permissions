...
class Admin
{
    ...
    public function getModuleInfo($args = [])
    {
        $title = [
            ...
            'content-visibility'            => esc_html__('Content Visibility', 'press-permit-core'),
            ...
            'sync'                          => esc_html__('User Posts', 'press-permit-core'),
        ];
        ...
        $blurb = [
            ...
            'content-visibility'            => esc_html__('Use [pp_restrict] to show or hide sections of content based on login status, roles, capabilities, users, or Permission Groups.', 'press-permit-core'),
        ...
        $descript = [
            ...
            'content-visibility'            => esc_html__('The [pp_restrict] shortcode conditionally displays sections of post content. Rules can require login status, roles, capabilities, usernames, or Permission Group membership.', 'press-permit-core'),
